...
//        options.Audience = "SsMonitor.Client"; // Change to your API's audience value
...
//        {
//            ValidateIssuer = true,
//            ValidIssuer="ssmonitor.pk",// Set to true if you want to validate the issuer
//            ValidateAudience = false, // Set to true if you want to validate the audience
//            ValidateLifetime = true, // Ensure the token hasn't expired
//            ValidateIssuerSigningKey = true, // Ensure the signing key is valid
//            IssuerSigningKey = new SymmetricSecurityKey(
//                Encoding.UTF8.GetBytes(builder.Configuration.GetSection("JWT:Key").Value!)), // Get the secret key from appsettings.json
